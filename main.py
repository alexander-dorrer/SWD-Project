...
# Create Tower
my_tower = Tower(display_surface,100,200,5)
my_tower2 = Tower(display_surface,150,300,10)
...
while True:
    ...
    for event in event_list:
        ...
        if event.type == SHOOT and round_started:
            ...
            money, enemy_killed = my_enemy.get_shot(my_tower2.shoot(my_enemy.position(), my_enemy.is_alive()), money)
            ...
            my_tower2.projectile(my_enemy.position(), my_enemy.is_alive())

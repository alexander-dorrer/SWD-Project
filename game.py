...
class Game:
    ...
    def draw_hud(self, money):
        ...
        self.window.blit(pygame.transform.scale(tower2_base, (60, 60)), (420, self.height - 60))
        self.window.blit(pygame.transform.scale(tower2_head, (60, 60)), (420, self.height - 60))
